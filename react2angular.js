var react2angular = (function (exports,React,reactDom) {
'use strict';
...
var index_browser = createCommonjsModule(function (module, exports) {
  ...
  /** Detect free variable `exports`. */
  var freeExports$1 = 'object' == 'object' && exports && !exports.nodeType && exports;
    ...
    */
    ...
    createClass(NgComponent, [{
      ...
      value: function $onChanges(changes) {
        var oldProps = mapValues(changes, 'previousValue');
      ...
      key: 'didPropsChange',
      value: function didPropsChange(newProps, oldProps) {
        return some(newProps, function (v, k) {
          return v !== oldProps[k];
        });
      }
      /*
...
function react2angular(Class, bindingNames) {
    var names = bindingNames || Class.propTypes && Object.keys(Class.propTypes) || [];
    return {
        bindings: fromPairs(names.map(function (_) {
            return [_, '<'];
        })),
        controller: ['$element', function (_NgComponent) {
            inherits(_class, _NgComponent);
